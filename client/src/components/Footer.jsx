                        ...
                        <div>
                            ...
                            <div className="text-sm space-y-6 max-w-sm">
                                ...
                                <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-indigo-50">
                                    ...
                                    <button className="bg-primary px-4 py-2 text-white rounded cursor-pointer hover:opacity-90 transition">Subscribe</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p className="py-4 text-center border-t mt-6 border-slate-200 text-xs">
